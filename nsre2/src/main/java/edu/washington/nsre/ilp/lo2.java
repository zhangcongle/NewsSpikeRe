...
public class lo2 {
	...
	public static void main(String[] args) {
		...
		double aval[][] = { { 3.0, 2.0 }, { 1.0, 1.0, 2.0 }, { 2.0, 3.0 }, { 1.0, 3.0 } };
		mosek.Env.boundkey[] bkc = { mosek.Env.boundkey.fx, mosek.Env.boundkey.lo, mosek.Env.boundkey.up };
		double blc[] = { 30.0, 15.0, -infinity };
		double buc[] = { 30.0, +infinity, 25.0 };
		mosek.Env.boundkey bkx[] = { mosek.Env.boundkey.lo, mosek.Env.boundkey.ra, mosek.Env.boundkey.lo,
